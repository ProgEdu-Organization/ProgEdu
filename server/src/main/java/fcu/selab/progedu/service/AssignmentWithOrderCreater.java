...
public class AssignmentWithOrderCreater {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AssignmentWithOrderCreater.class);
    ...
    public AssignmentWithOrderCreater() {
        try {
