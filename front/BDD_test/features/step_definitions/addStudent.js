...
let driver = SingletDriver.getDriver();

Given('I have login', function () {
...
When('navigate to add student page', function () {
    ...
    passwordElement.sendKeys("rootrootrootroot");
...
Then("I will see", {timeout: 10 * 1000}, async function () {
